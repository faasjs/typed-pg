...
> **query**\<`T`\>(`table`): `QueryBuilder`\<`T`, `Flatten`\<`UnionToIntersection`\<`InferColumnType`\<`T`, [`ColumnName`](../type-aliases/ColumnName.md)\<`T`\>\>\>\>[]\>
...
`QueryBuilder`\<`T`, `Flatten`\<`UnionToIntersection`\<`InferColumnType`\<`T`, [`ColumnName`](../type-aliases/ColumnName.md)\<`T`\>\>\>\>[]\>
...
> `readonly` **options**: [`ClientOptions`](../type-aliases/ClientOptions.md)
