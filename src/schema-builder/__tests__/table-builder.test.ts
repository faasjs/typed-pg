...
describe('TableBuilder', () => {
  ...
  it('throws when renaming a missing create-mode column', () => {
    ...
    expect(() => table.renameColumn('missing', 'display_name'))
      .toThrowError('renameColumn failed: Column "missing" does not exist')
  })
  ...
  it('throws when altering a missing create-mode column', () => {
    ...
    expect(() => table.alterColumn('missing', { unique: true }))
      .toThrowError('alterColumn failed: Column "missing" does not exist')
  })
  ...
  it('throws when dropping missing create-mode index', () => {
    ...
    expect(() => table.dropIndex('name'))
      .toThrowError('dropIndex failed: Index "idx_users_name" does not exist')
  })
